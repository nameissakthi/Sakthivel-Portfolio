...
import logo from "/images/section/hero-img.png"
        ...
        <div className="container">
          <div className="st-main-header-in">
            <div className="st-main-header-left">
              <Link className="st-site-branding" to='/' id="hero"><img src={logo} alt="Davis" /></Link>
            </div>
            <div className="st-main-header-right">
              <div className="st-nav">
                ...
                <div className="sp-phone">
                  ...
                  <div className="sp-phone-no">+91 6382968373</div>
                </div>
              </div>
            </div>
          </div>
