        ...
        <div className="row">
          {
            skills.map((element, index) => (
              <div className="col-lg-3 col-md-4 col-sm-6 col-6" key={index} data-aos={element.effect ? element.effect : "zoom-out-up"} data-aos-duration={element.duration ? element.duration : "800"} data-aos-delay={element.delay ? element.delay : "200"}>
